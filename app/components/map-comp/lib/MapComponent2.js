...
export default class MapComponent2 extends Component {
  componentDidMount() {
    console.log('didupdatecomp2')
  ...
  buildMap() {
    this.map = new google.maps.Map(document.getElementById('map2'), this.mapConfig)
...
evtNames.forEach((e) => (MapComponent2.propTypes[camelize(e)] = PropTypes.func))
