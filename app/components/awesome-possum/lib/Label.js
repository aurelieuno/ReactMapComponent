...
var Label = function (_Component) {
  ...
  _createClass(Label, [{
    ...
    value: function render() {
      ...
      var newClassName = (0, _classnames2.default)(className, 'label', 'rev-Label', propClassNames);

      return _react2.default.createElement(
        'span',
        _extends({}, props, { className: newClassName }),
        icon ? _react2.default.createElement(_Icon2.default, { i: icon, className: 'rev-Label-icon' }) : null,
        ' ',
        children
      );
    }
