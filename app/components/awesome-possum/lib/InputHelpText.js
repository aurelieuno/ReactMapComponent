...
var InputHelpText = function (_Component) {
  _inherits(InputHelpText, _Component);

  function InputHelpText() {
    _classCallCheck(this, InputHelpText);

    return _possibleConstructorReturn(this, (InputHelpText.__proto__ || Object.getPrototypeOf(InputHelpText)).apply(this, arguments));
  }
  ...
  _createClass(InputHelpText, [{
    ...
    value: function render() {
      ...
      var newClassName = (0, _classnames2.default)(className, 'rev-InputHelpText');
