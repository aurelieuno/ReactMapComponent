  ...
  _createClass(InputLabel, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          props = _objectWithoutProperties(_props, ['error', 'className', 'children']);

      var labelClassName = (0, _classnames2.default)(className, 'rev-InputLabel', {
      ...
      return _react2.default.createElement(
        'label',
        _extends({ className: labelClassName }, props),
        children
      );
    }
  }]);
