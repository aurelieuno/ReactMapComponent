...
var CloseButton = function (_Component) {
  ...
  _createClass(CloseButton, [{
    ...
    value: function render() {
      ...
      var classNamesList = (0, _classnames2.default)('rev-CloseButton', className);

      return _react2.default.createElement(
        'button',
        _extends({ type: 'button' }, props, { className: classNamesList }),
        this.props.children
      );
    }
  }]);
...
CloseButton.propTypes = PROP_TYPES;
