...
var Tokenizer = function (_React$Component) {
  ...
  _createClass(Tokenizer, null, [{
    ...
    get: function get() {
      return {
        ...
        remoteOptionsUrl: _propTypes2.default.string,
        queryParam: _propTypes2.default.string,
        selectedItems: _propTypes2.default.array,
        inputClassName: _propTypes2.default.string,
        optionListClassName: _propTypes2.default.string,
        optionClassName: _propTypes2.default.string,
        tokenListClassName: _propTypes2.default.string,
        tokenClassName: _propTypes2.default.string,
        removeButtonClassName: _propTypes2.default.string,
        leaveOpen: _propTypes2.default.bool,
        getItemValue: _propTypes2.default.func,
        getOptionComponent: _propTypes2.default.func,
        getTokenComponent: _propTypes2.default.func,
        getInputName: _propTypes2.default.func
  ...
  _createClass(Tokenizer, [{
    ...
    value: function setOptions(items) {
      ...
      rejectItem = function rejectItem(item) {
